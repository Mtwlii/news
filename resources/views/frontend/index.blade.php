                    ...
                    <div class="tab-content">
                        @foreach ($gratest_Post_Comments as $comments)
                            <div id="featured" class="container tab-pane active">
                                <div class="tn-news">
                                    <div class="tn-img">
                                        <img src="{{ asset($comments->images->first()->path) }}" />
                                    </div>
                                    <div class="tn-title">
                                        <a href=" {{ route('frontend.post.show', $post->slug) }}">{{ $comments->title }}
                        ...
                        <div id="popular" class="container tab-pane fade">
                            @foreach ($oldest_news as $new)
                                <div class="tn-news">
                                    <div class="tn-img">
                                        <img src="{{ asset($new->images->first()->path) }}" />
                                    </div>
                                    <div class="tn-title">
                                        <a href="{{ route('frontend.post.show', $post->slug) }}">{{ $new->title }}</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                                ...
                                <div class="tn-news">
                                    ...
                                    <div class="tn-title">
                                        <a href="{{ route('frontend.post.show', $post->slug) }}">{{ $post->title }}
                                            <span class="text-right text-muted">Number
